...
class CartServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton('cart', function ($app) {
            ...
            // calling Cart::session($sessionKey)->add() e.g., when adding a
            // cart for a specific user name. Session Key can be string or maybe
            // a unique identifier to bind a cart to a specific user, this can
            // also be a user ID.
